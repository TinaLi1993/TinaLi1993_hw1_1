...
INSERT INTO portrays (actor_id, movie_id, char_name)
VALUES
    (1, 1, 'Bruce Wayne'),
    (2, 1, 'Alfred'),
    (3, 1, 'Ra s Al Ghul'),
...
-- TODO!
SELECT movie_title,year_released ,MPAA_rating,studio_name from movies;
...
FROM
    portrays
JOIN
    movies ON portrays.movie_id = movies.id
JOIN
    actors ON portrays.actor_id = actors.id;